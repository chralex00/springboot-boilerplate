...
@Slf4j
@RestController
@RequestMapping("/api/v1/admin/tdees")
public class AdminTdeeController {
    @Autowired
    ...
    public ResponseEntity<?> count(
        ...
        try {
            ...
            AdminTdeeController.log.error("error occurred counting the tdees");
            AdminTdeeController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(TdeeUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }

    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody CreateTdeeDto createTdeeDto, BindingResult bindingResult) {
        try {
            TdeeUtils.validateCreateOrUpdateTdeeDto(bindingResult);

            this.accountService
                .findOne(createTdeeDto.getAccountId())
            ...
            AdminTdeeController.log.error("error occurred creating the tdee");
            AdminTdeeController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(TdeeUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<?> findOne(@PathVariable String id) {
        try {
            ...
            AdminTdeeController.log.error("error occurred retrieving the tdee");
            AdminTdeeController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(TdeeUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<?> findMany(
        ...
        try {
            ...
            AdminTdeeController.log.error("error occurred retrieving the tdees");
            AdminTdeeController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(TdeeUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<?> updateOne(@PathVariable String id, @Valid @RequestBody UpdateTdeeDto updateTdeeDto, BindingResult bindingResult) {
        try {
            ...
            this.accountService
                .findOne(updateTdeeDto.getAccountId())
                .orElseThrow(() -> new ResourceNotFoundException("account not found"));
            ...
            AdminTdeeController.log.error("error occurred updating the tdee");
            AdminTdeeController.log.error("error message is " + exception.getMessage());
    ...
    public ResponseEntity<?> deleteOne(@PathVariable String id) {
        try {
            ...
            AdminTdeeController.log.error("error occurred during the tdee deletion");
            AdminTdeeController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(TdeeUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
