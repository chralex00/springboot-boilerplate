...
@Slf4j
@RestController
@RequestMapping("/api/v1/user/diets")
public class UserDietController {
    ...
    public ResponseEntity<?> count(
        ...
        try {
            ...
            UserDietController.log.error("error occurred counting the diets");
            UserDietController.log.error("error message is " + exception.getMessage());
    ...
    public ResponseEntity<?> create(
        @Valid @RequestBody CreateDietDto createDietDto,
        ...
        try {
            ...
            dietToCreate.setAccountId(accountId);
            ...
            UserDietController.log.error("error occurred creating the diet");
            UserDietController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(DietUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<?> findOne(@PathVariable String id, @RequestAttribute("accountId") String accountId) {
        try {
            Diet dietFound = this.dietService.findOneByIdAndAccountId(id, accountId).orElseThrow(ResourceNotFoundException::new);
            ...
            UserDietController.log.error("error occurred retrieving the diet");
            UserDietController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(DietUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<?> findMany(
        ...
        try {
            ...
            UserDietController.log.error("error occurred retrieving the diets");
            UserDietController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(DietUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<?> updateOne(
        ...
        @Valid @RequestBody UpdateDietDto updateDietDto,
        BindingResult bindingResult,
        @RequestAttribute("accountId") String accountId
    ) {
        try {
            ...
            dietToUpdate.setAccountId(accountId);
            ...
            UserDietController.log.error("error occurred updating the diet");
            UserDietController.log.error("error message is " + exception.getMessage());
    ...
    public ResponseEntity<?> deleteOne(@PathVariable String id, @RequestAttribute("accountId") String accountId) {
        try {
            Diet dietToDelete = this.dietService.findOneByIdAndAccountId(id, accountId).orElseThrow(ResourceNotFoundException::new);
            ...
            UserDietController.log.error("error occurred during the diet deletion");
            UserDietController.log.error("error message is " + exception.getMessage());
            return new ResponseEntity<ErrorResponseDto>(DietUtils.getInternalServerError(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
